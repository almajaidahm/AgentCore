...
#[derive(Debug)]
pub struct AgentCoreProProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AgentCoreProProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AgentCorePro processing");
    
    let mut processor = AgentCoreProProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AgentCoreProProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AgentCoreProProcessor::new(false);
